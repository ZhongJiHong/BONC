...
import com.bonc.bdevutils.com.bonc.bdev.entity.exception.ErrorCodes;
import com.bonc.bdevutils.com.bonc.bdev.entity.exception.HosServerException;
...
public class HBaseOp {
    ...
    /**
     * 查看底层，方法表示原子性的增加一列的值，如果这列的值已经存在并且不是一个big-endian long型的值，将会抛出异常;
     * 如果值不存在，则num被初始化写入到指定的列;
     *
     * @param connection
     * @param tableName
     * @param row
